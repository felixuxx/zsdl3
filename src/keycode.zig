...
pub const SDL_SCANCODE_SLEEP = 258;
pub const SDL_SCANCODE_WAKE = 259;
pub const SDL_SCANCODE_CHANNEL_INCREMENT = 260;
pub const SDL_SCANCODE_CHANNEL_DECREMENT = 261;
pub const SDL_SCANCODE_MEDIA_PLAY = 262;
pub const SDL_SCANCODE_MEDIA_PAUSE = 263;
pub const SDL_SCANCODE_MEDIA_RECORD = 264;
pub const SDL_SCANCODE_MEDIA_FAST_FORWARD = 265;
pub const SDL_SCANCODE_MEDIA_REWIND = 266;
pub const SDL_SCANCODE_MEDIA_NEXT_TRACK = 267;
pub const SDL_SCANCODE_MEDIA_PREVIOUS_TRACK = 268;
pub const SDL_SCANCODE_MEDIA_STOP = 269;
pub const SDL_SCANCODE_MEDIA_EJECT = 270;
pub const SDL_SCANCODE_MEDIA_PLAY_PAUSE = 271;
pub const SDL_SCANCODE_MEDIA_SELECT = 272;
pub const SDL_SCANCODE_AC_NEW = 273;
pub const SDL_SCANCODE_AC_OPEN = 274;
pub const SDL_SCANCODE_AC_CLOSE = 275;
pub const SDL_SCANCODE_AC_EXIT = 276;
pub const SDL_SCANCODE_AC_SAVE = 277;
pub const SDL_SCANCODE_AC_PRINT = 278;
pub const SDL_SCANCODE_AC_PROPERTIES = 279;
pub const SDL_SCANCODE_AC_SEARCH = 280;
pub const SDL_SCANCODE_AC_HOME = 281;
pub const SDL_SCANCODE_AC_BACK = 282;
pub const SDL_SCANCODE_AC_FORWARD = 283;
pub const SDL_SCANCODE_AC_STOP = 284;
pub const SDL_SCANCODE_AC_REFRESH = 285;
pub const SDL_SCANCODE_AC_BOOKMARKS = 286;
...
pub const SDL_SCANCODE_RESERVED = 400;
pub const SDL_SCANCODE_COUNT = 512;
...
pub const SDLK_WAKE = SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_WAKE);
pub const SDLK_CHANNEL_INCREMENT = SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_CHANNEL_INCREMENT);
pub const SDLK_CHANNEL_DECREMENT = SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_CHANNEL_DECREMENT);
pub const SDLK_MEDIA_PLAY = SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_MEDIA_PLAY);
pub const SDLK_MEDIA_PAUSE = SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_MEDIA_PAUSE);
pub const SDLK_MEDIA_RECORD = SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_MEDIA_RECORD);
pub const SDLK_MEDIA_FAST_FORWARD = SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_MEDIA_FAST_FORWARD);
pub const SDLK_MEDIA_REWIND = SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_MEDIA_REWIND);
pub const SDLK_MEDIA_NEXT_TRACK = SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_MEDIA_NEXT_TRACK);
pub const SDLK_MEDIA_PREVIOUS_TRACK = SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_MEDIA_PREVIOUS_TRACK);
pub const SDLK_MEDIA_STOP = SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_MEDIA_STOP);
pub const SDLK_MEDIA_EJECT = SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_MEDIA_EJECT);
pub const SDLK_MEDIA_PLAY_PAUSE = SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_MEDIA_PLAY_PAUSE);
pub const SDLK_MEDIA_SELECT = SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_MEDIA_SELECT);
pub const SDLK_AC_NEW = SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_AC_NEW);
pub const SDLK_AC_OPEN = SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_AC_OPEN);
pub const SDLK_AC_CLOSE = SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_AC_CLOSE);
pub const SDLK_AC_EXIT = SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_AC_EXIT);
pub const SDLK_AC_SAVE = SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_AC_SAVE);
pub const SDLK_AC_PRINT = SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_AC_PRINT);
pub const SDLK_AC_PROPERTIES = SDL_SCANCODE_TO_KEYCODE(SDL_SCANCODE_AC_PROPERTIES);
...
// Additional printable keycodes
pub const SDLK_LEFTBRACE = 0x7B;
pub const SDLK_PIPE = 0x7C;
pub const SDLK_RIGHTBRACE = 0x7D;
pub const SDLK_TILDE = 0x7E;
pub const SDLK_PLUSMINUS = 0xB1;
...
// Extended keycodes
pub const SDLK_LEFT_TAB = 0x20000001;
pub const SDLK_LEVEL5_SHIFT = 0x20000002;
pub const SDLK_MULTI_KEY_COMPOSE = 0x20000003;
pub const SDLK_LMETA = 0x20000004;
pub const SDLK_RMETA = 0x20000005;
pub const SDLK_LHYPER = 0x20000006;
pub const SDLK_RHYPER = 0x20000007;
