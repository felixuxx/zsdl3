...
extern fn SDL_CreatePopupWindow(parent: ?*SDL_Window, offset_x: c_int, offset_y: c_int, w: c_int, h: c_int, flags: SDL_WindowFlags) ?*SDL_Window;
...
extern fn SDL_GetWindowSurfaceVSync(window: ?*SDL_Window, vsync: ?*c_int) bool;
extern fn SDL_SetWindowSurfaceVSync(window: ?*SDL_Window, vsync: c_int) bool;
extern fn SDL_GetWindowICCProfile(window: ?*SDL_Window, size: ?*usize) ?*anyopaque;
extern fn SDL_GetWindowSafeArea(window: ?*SDL_Window, rect: ?*SDL_Rect) bool;
...
extern fn SDL_SetWindowFillDocument(window: ?*SDL_Window, fill: bool) bool;
